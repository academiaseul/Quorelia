...
<p style="color:#9fb2bd;font-size:11px;max-width:5.4in;margin-top:14px;">Preparado bajo la metodología de monitoreo y verificación continua de Quorelia, sobre los sistemas SCADA y BMS ya instalados en la instalación. Sin reemplazo de equipamiento.</p>
...
<tr><td style="color:#8fa0ab;">Potencia / Capacidad</td><td style="color:#fff;">{POT:.0f} MW / {CAP:.0f} MWh</td></tr>
